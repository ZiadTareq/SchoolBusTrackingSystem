        ...
        FirebaseDatabase.getInstance().getReference().addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (getResult()[0] <= 1000 && getResult()[0] != 0) {
                    NotificationCompat.Builder notifi = (NotificationCompat.Builder) new NotificationCompat.Builder(MapsActivity.this, "")
                ...
                if (lat != null && lng != null) {
                    ...
                    mMap.addMarker(new MarkerOptions().position(buspo).title("the bus position")
                            .icon(BitmapDescriptorFactory.fromResource(R.drawable.rsz_bus)));
